...
const addTransfer = async (req, res) => {
  ...
  const newFromAccountValue = parseFloat(currentFromAccountValue) - parseFloat(value);

  const newToAccountValue = parseFloat(currentToAccountValue) + parseFloat(value);
